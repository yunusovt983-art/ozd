...
### Арка W28 — Health endpoint v2: /healthz расширенный
...
### Арка W29 — Конфиг hot-reload: SIGHUP перечитывает часть полей
...
### Арка W30 — Admin: GET /admin/config (read-only introspection)
...
### Арка W31 — Retention: DELETE /admin/snapshot/old?keep=N
...
## Приоритизация (MoSCoW) — Неделя 7

| Must | Should | Could | Won't (эта неделя) |
|------|--------|-------|---------------------|
| W27 error taxonomy | W28 healthz v2 | W30 /admin/config | Multi-node (Ч3) |
| W29 SIGHUP reload | | W31 retention | reed-solomon-simd |
