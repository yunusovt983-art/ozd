...
|--------|------------|------------|
| `ozd-app` | ~5 143 | Бизнес-логика (pool, cache, CAR, erasure, placement…) |
...
| Прочее (ROADMAP, KUBO, BENCH, WEEKLY-ARCS…) | ~820 |
| **Итого Wiki** | **~20 116** |
...
| Документация (Wiki + README) | ~20 116 |
| **Всего по проекту** | **~31 592** |
